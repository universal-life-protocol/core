...
var Rp = D((mM, Op) => {
  ...
  x();
  I();
  var { Buffer: ft } = (ke(), me(qe)), Pp = /* @__PURE__ */ Symbol.for("BufferList");
  function be(t) {
...
var vy = D((_o) => {
  ...
  var NE = (t) => !wy.has(t), yL = /* @__PURE__ */ Symbol("type"), lr = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t), _y = (t) => lr(t) ? t <= Math.pow(2, 8) ? Uint8Array : t <= Math.pow(2, 16) ? Uint16Array : t <= Math.pow(2, 32) ? Uint32Array : t <= Number.MAX_SAFE_INTEGER ? bn : null : null, bn = class extends Array {
    constructor(e) {
      super(e), this.fill(0);
    }
  }, $a = class t {
  ...
  (function(t, e) {
    ...
    var i = /* @__PURE__ */ new Map([[0, null]]), s = /* @__PURE__ */ new Map([[0, null]]), o = r.createBroker({ clearInterval: function(f) {
      ...
      return function(d) {
        ...
        var b = /* @__PURE__ */ Symbol(), m = n.generateUniqueNumber(i);
        i.set(m, b);
        var v = function() {
      ...
      return function(d) {
        for (var w = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, y = arguments.length, P = new Array(y > 2 ? y - 2 : 0), E = 2; E < y; E++) P[E - 2] = arguments[E];
        var b = /* @__PURE__ */ Symbol(), m = n.generateUniqueNumber(s);
